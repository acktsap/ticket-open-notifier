...
class InMemoryViewedTicketOpenRepository(
    ...
    private val viewedSet = object : LinkedHashMap<TicketOpen, Boolean>(capacity, 0.75F, true) {
    ...
    override fun exists(ticketOpen: TicketOpen): Boolean {
        return viewedSet.containsKey(ticketOpen)
    }
}
